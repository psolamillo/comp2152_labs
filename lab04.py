...
#Q5: THe player collects the loot
print("You found loot!")
input("Roll the dice for you first item (Press Enter)")
...
loot_item2 = loot_options.pop(loot_item_idx)
belt.append(loot_item2)
print(f"You now have {belt}")

#Q7
print("The belt is being organized")
belt.sort()
print(belt)
